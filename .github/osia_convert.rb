...
def write_archive(j)
  t    = j['title']
  desc = "This is an archive of the [main list](https://github.com/vitorebatista/open-source-react-native-apps) for projects that are no longer maintained / old.\n\n"
